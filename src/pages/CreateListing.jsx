...
export default function CreateListing() {
  ...
  async function onSubmit(e) {
    ...
    if(images.length > 6){
      setLoading(false)
      toast.error("Images needs to be less than 6");
      return;
    }
    let geolocation = {};
    let location;
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <button 
          type="submit"
          className="mb-6 bg-blue-800 px-7 py-3.5 w-full 
          rounded border text-white font-medium font-sm 
          uppercase shadow-md hover:bg-blue-900 hover:shadow-lg 
          focus:bg-blue-700 
